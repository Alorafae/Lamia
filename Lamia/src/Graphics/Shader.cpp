...
void Shader::UpdateUniform(DeviceInfo & di, float dt, glm::mat4 mvp)
{
  VkResult U_ASSERT_ONLY res;
...
void Shader::BindUBO(DeviceInfo &di, glm::mat4 &mvp)
{
...
VkDescriptorBufferInfo Shader::GetUBOInfo(void)
{
  return UBufferInfo;
}
